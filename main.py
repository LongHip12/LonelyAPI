...
# ==================== CONFIG ====================
SELFBOT_TOKEN = "MTE4NzYxODg0MDI1MTc0MDE2Mw.G8BYCM.xP6ifj43YyN5tFuRJT-R1nswnhR0QMQIZ3r5WE"
...
EVENT_TYPES = {
    ...
    "tyrant": {"name": "🌪️ Tyrant of Skies", "pattern": "Tyrant of the Skies Spawned", "emoji": "🌪️", "category": "legendary_boss"},
    ...
    "darkbeard": {"name": "🏴‍☠️ Darkbeard", "pattern": "Darkbeard Spawned", "emoji": "🏴‍☠️", "category": "legendary_boss"},
    ...
    "all": {"name": "📢 Tất cả", "emoji": "📢", "category": "special"},
    "island": {"name": "🏝️ Tất cả Đảo", "emoji": "🏝️", "category": "special"},
    "boss": {"name": "👹 Tất cả Boss", "emoji": "👹", "category": "special"},
    "legendary": {"name": "⭐ Tất cả Legendary", "emoji": "⭐", "category": "special"},
}
